...
const Footer = () => {
    return (
        ...
        <div className="Footer">
            ...
            <div className="row mb-4 custom-footer">
            <div className="col-md-3 col-sm-12 col-lg-2 Footer-Content">
            ...
            <div className="col-lg-2 col-md-3 col-sm-12 Footer-Content">
            <div className="Footer-Heading">
                <h5>About</h5>
                </div>
            ...
            <div className="col-lg-4 col-md-3 col-sm-12 Payment-method-mt Footer-Content">
            <div className="Footer-Heading">
        ...
        <div className="Footer-Bottom-Content">
            <div className="Footer-Para mt-3  pb-3">
